...
df = pd.read_csv("../gnc/references/mqekf_quaternion_output.csv")
...
rotations = R.from_quat(quaternions).inv()
...
ani = FuncAnimation(fig, update, frames=len(rotations), interval=25, blit=False)
