...
const float max_velocity_x = 2000;
const float max_velocity_y = 2000;
const float max_velocity_z = 2000;
const float max_acceleration_ax = 2000;
const float max_acceleration_ay = 2000;
const float max_acceleration_az = 2000;
const float max_orientation_roll = 2000;
const float max_orientation_yaw = 2000;
const float max_orientation_pitch = 2000;
