...
{
    sigma_a = {accel_noise_density_x * sqrt(s_dt) * 1e-6 * 9.81, accel_noise_density_y * sqrt(s_dt) * 1e-6 * 9.81, accel_noise_density_z * sqrt(s_dt) * 1e-6 * 9.81}; // ug/sqrt(Hz) *sqrt(thread speed). values are from datasheet
