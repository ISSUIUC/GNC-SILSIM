...
{
    public:
        constexpr QuaternionMEKF(Vector3 const& sigma_a, Vector3 const& sigma_g, Vector3 const& sigma_m, float Pq0 = 1e-6, float Pb0 = 1e-1);
        ...
        void time_update(Vector3 const& gyr, float Ts);
    ...
    private:
        ...
        void set_transition_matrix(const Eigen::Ref<const Vector3>& gyr, float Ts);
